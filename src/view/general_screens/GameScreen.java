...
public class GameScreen extends UiScreen {
    ...
    private Map<String, Boolean> basicZombieArmorVisibility(Zombie zombie) {
...
//        }
    ...
    private void drawZombies(float delta, float bw, float bh) {
        ...
        for (Zombie zombie : zombies) {
            ...
            Map<String, Boolean> armorVisibility = basicZombieArmorVisibility(zombie);
            boolean pamDrawn = armorVisibility != null
                    ? drawPam(path, preferred, animationTime, x - 10f, zombieOffsetY, 0.52f, zombie.isFacingRight(), armorVisibility)
                    : drawPam(path, preferred, animationTime, x - 10f, zombieOffsetY, 0.52f, zombie.isFacingRight());
            if (!pamDrawn) {
        ...
        armorStageIndex.keySet().removeIf(z -> !session.getZombies().contains(z));
    }
    ...
    protected boolean drawPam(String path, String preferred, float time, float x, float y, float scale, boolean flip,
        ...
        try {
            ...
            if (elementVisibility != null) {
                pamPlayer.draw(batch, clip, time, 0f, 0f, flip, elementVisibility);
            } else {
