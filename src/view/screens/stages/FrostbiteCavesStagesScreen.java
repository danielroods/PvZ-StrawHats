...
public class FrostbiteCavesStagesScreen extends StagesScreen {
    ...
    private static final String COMIC_SHEET_PATH = "assets/images/chapters/frostbite_cave/introcomic.png";
    ...
    public void initParticles() {
        setupParticles(SNOW_PARTICLE_PATH, 20, 5f, 15f, 1.2f);
    }
    ...
    private class StagePath extends Group {
        ...
        private void buildNode(Level level, int index, int stageNumber) {
            ...
            Image islandImage = new Image(getTextureDrawable(islandPath, (int) width, (int) height, new Color(0.35f, 0.62f, 0.82f, 1f)));
