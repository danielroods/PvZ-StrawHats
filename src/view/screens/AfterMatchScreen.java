...
public class AfterMatchScreen extends UiScreen {
    ...
    private String resultText = "Match finished.";
    ...
    public void show() {
        if (textureBank == null) {
            try {
                ...
                Gdx.app.error("AfterMatchScreen", "Failed to initialize PAM system", t);
            }
        }
        super.show();
        build();
    ...
    public void render(float delta) {
        if (textureBank != null) {
            try {
                ...
                Gdx.app.error("AfterMatchScreen", "textureBank.update() failed", t);
            }
        }
        super.render(delta);
    }
    ...
    private String resolvePinataPamPath() {
        ...
        if (seasonName == null) return PINATA_DARK;
        if (seasonName.equalsIgnoreCase("Big Wave Beach")) return PINATA_BEACH;
    ...
    private class PinataActor extends Actor {
        ...
        public void draw(Batch batch, float parentAlpha) {
            ...
            try {
                ...
                Gdx.app.error("AfterMatchScreen", "Failed to draw pinata (" + pamPath + ")", t);
            }
        }
    }
    ...
    private class PamIconActor extends Actor {
        ...
        public void draw(Batch batch, float parentAlpha) {
            ...
            try {
                ...
                Gdx.app.error("AfterMatchScreen", "Failed to draw pam icon (" + pamPath + ")", t);
            }
        }
    }
}